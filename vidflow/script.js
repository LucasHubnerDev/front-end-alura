...
async function buscarEMostrarVideos() {
  ...
  // posso usar esse métoto para seber se o código está em ambiente de produção ou desenvolvimento
  ...
  try {
    ...
    containerVideos.innerHTML = `<p>Houve um erro: ${error.message}</p>`;
  }
}
